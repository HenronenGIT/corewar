...
#for CHAMP in tests/*.cor; do ./corewar $CHAMP $CHAMP $CHAMP $CHAMP -v 1 >> mytest.txt; done
#for CHAMP in tests/*.cor; do ../eval_tests/corewar $CHAMP $CHAMP $CHAMP $CHAMP  >> origtest.txt; done
